            ...
            switch (this.status) {
                ...
                default:
                    ...
                    if (iteration <= 0) {
                        ...
                        vscode.window.showErrorMessage(`"${this.terminalName}" failed to launch.  Please check the terminal where it was started for more information.`);
                        this.launchTerminal?.show();
