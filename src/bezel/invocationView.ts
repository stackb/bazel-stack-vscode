...
import { ButtonName, ThemeIconSymbolEvent, ThemeIconCloudDownload, ThemeIconDebugStackframeFocused, ThemeIconDebugStackframe, ContextValue, ThemeIconReport, ruleClassIconUri, ThemeIconSymbolInterface, DiagnosticCollectionName, ThemeIconReload, ThemeIconInfo } from "../bzl/constants";
...
export class BuildEventProtocolView extends BzlClientTreeDataProvider<BazelBuildEventItem> {
    ...
    private progressItem: BuildProgressItem | undefined;
