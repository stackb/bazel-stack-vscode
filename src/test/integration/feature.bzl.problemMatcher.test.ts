...
describe.only(BzlFeatureName + ' Problems', function () {
	...
	const cases: ProblemMatcherTest[] = [
		{
			name: 'bazel',
			example: 'ERROR: C:/users/develop/_bazel_develop/jwzepo2u/external/com_github_gflags_gflags/BUILD:16:30: Executing genrule @com_github_gflags_gflags//:gflags_completions_h failed (Exit -1). Note: Remote connection/protocol failed with: execution failed',
			uri: 'file:///c%3A/users/develop/_bazel_develop/jwzepo2u/external/com_github_gflags_gflags/BUILD',
			markers: [{
				message: 'Executing genrule @com_github_gflags_gflags//:gflags_completions_h failed (Exit -1). Note: Remote connection/protocol failed with: execution failed',
				owner: 'bazel',
				resource: vscode.Uri.file('C:/users/develop/_bazel_develop/jwzepo2u/external/com_github_gflags_gflags/BUILD'),
