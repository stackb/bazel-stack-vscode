...
export interface _build_event_stream_TestResult_ExecutionInfo {
   ...
   */
  'hostname'?: (string);
  'timingBreakdown'?: (_build_event_stream_TestResult_ExecutionInfo_TimingBreakdown | null);
...
export interface _build_event_stream_TestResult_ExecutionInfo__Output {
   ...
   */
  'hostname': (string);
  'timingBreakdown': (_build_event_stream_TestResult_ExecutionInfo_TimingBreakdown__Output | null);
...
export interface TestResult {
   ...
   */
  'warning'?: (string)[];
  'executionInfo'?: (_build_event_stream_TestResult_ExecutionInfo | null);
  /**
...
export interface TestResult__Output {
   ...
   */
  'warning': (string)[];
  'executionInfo': (_build_event_stream_TestResult_ExecutionInfo__Output | null);
  /**
   * Additional details about the status of the test. This is intended for
   * user display and must not be parsed.
   */
