...
export interface BuildMetrics {
  actionSummary?: _build_event_stream_BuildMetrics_ActionSummary | null;
  memoryMetrics?: _build_event_stream_BuildMetrics_MemoryMetrics | null;
  targetMetrics?: _build_event_stream_BuildMetrics_TargetMetrics | null;
  packageMetrics?: _build_event_stream_BuildMetrics_PackageMetrics | null;
  timingMetrics?: _build_event_stream_BuildMetrics_TimingMetrics | null;
}

export interface BuildMetrics__Output {
  actionSummary: _build_event_stream_BuildMetrics_ActionSummary__Output | null;
  memoryMetrics: _build_event_stream_BuildMetrics_MemoryMetrics__Output | null;
  targetMetrics: _build_event_stream_BuildMetrics_TargetMetrics__Output | null;
  packageMetrics: _build_event_stream_BuildMetrics_PackageMetrics__Output | null;
  timingMetrics: _build_event_stream_BuildMetrics_TimingMetrics__Output | null;
}
