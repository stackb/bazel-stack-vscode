...
export interface BuildFinished {
   ...
   */
  exitCode?: _build_event_stream_BuildFinished_ExitCode;
  anomalyReport?: _build_event_stream_BuildFinished_AnomalyReport;
}
...
export interface BuildFinished__Output {
   ...
   * ExitCode.code equals 0.
   */
  exitCode?: _build_event_stream_BuildFinished_ExitCode__Output;
  anomalyReport?: _build_event_stream_BuildFinished_AnomalyReport__Output;
}
