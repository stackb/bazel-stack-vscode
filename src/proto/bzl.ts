...
import type { InfoServiceClient as _build_stack_bezel_v1beta1_InfoServiceClient } from './build/stack/bezel/v1beta1/InfoService';
    ...
    stack: {
      bezel: {
        v1beta1: {
          ...
          InfoService: SubtypeConstructor<typeof grpc.Client, _build_stack_bezel_v1beta1_InfoServiceClient> & { service: ServiceDefinition }
