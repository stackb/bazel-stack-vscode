...
export interface FailureDetail {
   ...
   */
  'message'?: (string);
  'interrupted'?: (_failure_details_Interrupted);
  'externalRepository'?: (_failure_details_ExternalRepository);
  'buildProgress'?: (_failure_details_BuildProgress);
  'remoteOptions'?: (_failure_details_RemoteOptions);
  'clientEnvironment'?: (_failure_details_ClientEnvironment);
  'crash'?: (_failure_details_Crash);
  'symlinkForest'?: (_failure_details_SymlinkForest);
  'packageOptions'?: (_failure_details_PackageOptions);
  'remoteExecution'?: (_failure_details_RemoteExecution);
  'category'?: "interrupted"|"externalRepository"|"buildProgress"|"remoteOptions"|"clientEnvironment"|"crash"|"symlinkForest"|"packageOptions"|"remoteExecution";
}
...
export interface FailureDetail__Output {
   ...
   */
  'message': (string);
  'interrupted'?: (_failure_details_Interrupted__Output);
  'externalRepository'?: (_failure_details_ExternalRepository__Output);
  'buildProgress'?: (_failure_details_BuildProgress__Output);
  'remoteOptions'?: (_failure_details_RemoteOptions__Output);
  'clientEnvironment'?: (_failure_details_ClientEnvironment__Output);
  'crash'?: (_failure_details_Crash__Output);
  'symlinkForest'?: (_failure_details_SymlinkForest__Output);
  'packageOptions'?: (_failure_details_PackageOptions__Output);
  'remoteExecution'?: (_failure_details_RemoteExecution__Output);
  'category': "interrupted"|"externalRepository"|"buildProgress"|"remoteOptions"|"clientEnvironment"|"crash"|"symlinkForest"|"packageOptions"|"remoteExecution";
}
