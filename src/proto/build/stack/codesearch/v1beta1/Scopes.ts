...
export interface ScopesDefinition extends grpc.ServiceDefinition {
  Create: MethodDefinition<
    _build_stack_codesearch_v1beta1_CreateScopeRequest,
    _build_stack_codesearch_v1beta1_CreateScopeResponse,
    _build_stack_codesearch_v1beta1_CreateScopeRequest__Output,
    _build_stack_codesearch_v1beta1_CreateScopeResponse__Output
  >;
  Get: MethodDefinition<
    _build_stack_codesearch_v1beta1_GetScopeRequest,
    _build_stack_codesearch_v1beta1_Scope,
    _build_stack_codesearch_v1beta1_GetScopeRequest__Output,
    _build_stack_codesearch_v1beta1_Scope__Output
  >;
  List: MethodDefinition<
    _build_stack_codesearch_v1beta1_ListScopesRequest,
    _build_stack_codesearch_v1beta1_ListScopesResponse,
    _build_stack_codesearch_v1beta1_ListScopesRequest__Output,
    _build_stack_codesearch_v1beta1_ListScopesResponse__Output
  >;
}
