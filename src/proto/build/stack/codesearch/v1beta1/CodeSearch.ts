...
export interface CodeSearchDefinition extends grpc.ServiceDefinition {
  Search: MethodDefinition<_build_stack_codesearch_v1beta1_ScopedQuery, _livegrep_CodeSearchResult, _build_stack_codesearch_v1beta1_ScopedQuery__Output, _livegrep_CodeSearchResult__Output>
}
