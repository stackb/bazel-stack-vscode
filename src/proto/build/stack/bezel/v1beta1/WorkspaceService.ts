...
export interface WorkspaceServiceDefinition extends grpc.ServiceDefinition {
  Get: MethodDefinition<_build_stack_bezel_v1beta1_GetWorkspaceRequest, _build_stack_bezel_v1beta1_Workspace, _build_stack_bezel_v1beta1_GetWorkspaceRequest__Output, _build_stack_bezel_v1beta1_Workspace__Output>
  List: MethodDefinition<_build_stack_bezel_v1beta1_ListWorkspacesRequest, _build_stack_bezel_v1beta1_ListWorkspacesResponse, _build_stack_bezel_v1beta1_ListWorkspacesRequest__Output, _build_stack_bezel_v1beta1_ListWorkspacesResponse__Output>
}
