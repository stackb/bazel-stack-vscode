...
import type { ExternalListWorkspacesRequest as _build_stack_bezel_v1beta1_ExternalListWorkspacesRequest, ExternalListWorkspacesRequest__Output as _build_stack_bezel_v1beta1_ExternalListWorkspacesRequest__Output } from '../../../../build/stack/bezel/v1beta1/ExternalListWorkspacesRequest';
import type { ExternalListWorkspacesResponse as _build_stack_bezel_v1beta1_ExternalListWorkspacesResponse, ExternalListWorkspacesResponse__Output as _build_stack_bezel_v1beta1_ExternalListWorkspacesResponse__Output } from '../../../../build/stack/bezel/v1beta1/ExternalListWorkspacesResponse';
...
export interface ExternalWorkspaceServiceHandlers extends grpc.UntypedServiceImplementation {
  ListExternal: grpc.handleUnaryCall<_build_stack_bezel_v1beta1_ExternalListWorkspacesRequest__Output, _build_stack_bezel_v1beta1_ExternalListWorkspacesResponse>;
  
}

export interface ExternalWorkspaceServiceDefinition extends grpc.ServiceDefinition {
  ListExternal: MethodDefinition<_build_stack_bezel_v1beta1_ExternalListWorkspacesRequest, _build_stack_bezel_v1beta1_ExternalListWorkspacesResponse, _build_stack_bezel_v1beta1_ExternalListWorkspacesRequest__Output, _build_stack_bezel_v1beta1_ExternalListWorkspacesResponse__Output>
}
