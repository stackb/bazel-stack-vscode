...
export interface ExternalWorkspaceServiceDefinition extends grpc.ServiceDefinition {
  ListExternal: MethodDefinition<
    _build_stack_bezel_v1beta1_ExternalListWorkspacesRequest,
    _build_stack_bezel_v1beta1_ExternalListWorkspacesResponse,
    _build_stack_bezel_v1beta1_ExternalListWorkspacesRequest__Output,
    _build_stack_bezel_v1beta1_ExternalListWorkspacesResponse__Output
  >;
}
