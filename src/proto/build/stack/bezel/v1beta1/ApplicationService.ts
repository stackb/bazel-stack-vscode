...
export interface ApplicationServiceHandlers {
  GetMetadata(call: grpc.ServerUnaryCall<_build_stack_bezel_v1beta1_GetMetadataRequest, _build_stack_bezel_v1beta1_Metadata__Output>, callback: grpc.sendUnaryData<_build_stack_bezel_v1beta1_Metadata__Output>): void;
