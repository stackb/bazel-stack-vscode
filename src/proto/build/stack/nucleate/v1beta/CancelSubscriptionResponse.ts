...
export interface CancelSubscriptionResponse {
  subscription?: _build_stack_nucleate_v1beta_Subscription | null;
}

export interface CancelSubscriptionResponse__Output {
  subscription: _build_stack_nucleate_v1beta_Subscription__Output | null;
}
