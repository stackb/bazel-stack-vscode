...
export interface SubscriptionsDefinition extends grpc.ServiceDefinition {
  CancelSubscription: MethodDefinition<_build_stack_nucleate_v1beta_CancelSubscriptionRequest, _build_stack_nucleate_v1beta_CancelSubscriptionResponse, _build_stack_nucleate_v1beta_CancelSubscriptionRequest__Output, _build_stack_nucleate_v1beta_CancelSubscriptionResponse__Output>
  CreateSubscription: MethodDefinition<_build_stack_nucleate_v1beta_CreateSubscriptionRequest, _build_stack_nucleate_v1beta_Subscription, _build_stack_nucleate_v1beta_CreateSubscriptionRequest__Output, _build_stack_nucleate_v1beta_Subscription__Output>
}
