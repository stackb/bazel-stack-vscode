...
import type {
  PaymentSource as _build_stack_nucleate_v1beta_PaymentSource,
  PaymentSource__Output as _build_stack_nucleate_v1beta_PaymentSource__Output,
...
export interface CreateSubscriptionRequest {
   ...
   */
  paymentSource?: _build_stack_nucleate_v1beta_PaymentSource | null;
}
...
export interface CreateSubscriptionRequest__Output {
   ...
   * if the card params are being explicitly specified
   */
  paymentSource: _build_stack_nucleate_v1beta_PaymentSource__Output | null;
}
