...
import type {
  CacheCapabilities as _build_bazel_remote_execution_v2_CacheCapabilities,
  CacheCapabilities__Output as _build_bazel_remote_execution_v2_CacheCapabilities__Output,
} from '../../../../../build/bazel/remote/execution/v2/CacheCapabilities';
import type {
  ExecutionCapabilities as _build_bazel_remote_execution_v2_ExecutionCapabilities,
  ExecutionCapabilities__Output as _build_bazel_remote_execution_v2_ExecutionCapabilities__Output,
} from '../../../../../build/bazel/remote/execution/v2/ExecutionCapabilities';
import type {
  SemVer as _build_bazel_semver_SemVer,
  SemVer__Output as _build_bazel_semver_SemVer__Output,
} from '../../../../../build/bazel/semver/SemVer';
