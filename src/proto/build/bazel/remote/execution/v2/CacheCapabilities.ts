...
import type {
  ActionCacheUpdateCapabilities as _build_bazel_remote_execution_v2_ActionCacheUpdateCapabilities,
  ActionCacheUpdateCapabilities__Output as _build_bazel_remote_execution_v2_ActionCacheUpdateCapabilities__Output,
} from '../../../../../build/bazel/remote/execution/v2/ActionCacheUpdateCapabilities';
import type {
  PriorityCapabilities as _build_bazel_remote_execution_v2_PriorityCapabilities,
  PriorityCapabilities__Output as _build_bazel_remote_execution_v2_PriorityCapabilities__Output,
} from '../../../../../build/bazel/remote/execution/v2/PriorityCapabilities';
...
export interface CacheCapabilities {
   ...
   */
  digestFunction?: (
    | _build_bazel_remote_execution_v2_DigestFunction_Value
    | keyof typeof _build_bazel_remote_execution_v2_DigestFunction_Value
  )[];
  /**
  ...
  symlinkAbsolutePathStrategy?:
    | _build_bazel_remote_execution_v2_SymlinkAbsolutePathStrategy_Value
    | keyof typeof _build_bazel_remote_execution_v2_SymlinkAbsolutePathStrategy_Value;
}
