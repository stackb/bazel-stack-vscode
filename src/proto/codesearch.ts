...
import type {
  CodeSearchClient as _build_stack_codesearch_v1beta1_CodeSearchClient,
  CodeSearchDefinition as _build_stack_codesearch_v1beta1_CodeSearchDefinition,
} from './build/stack/codesearch/v1beta1/CodeSearch';
import type {
  ScopesClient as _build_stack_codesearch_v1beta1_ScopesClient,
  ScopesDefinition as _build_stack_codesearch_v1beta1_ScopesDefinition,
} from './build/stack/codesearch/v1beta1/Scopes';
import type {
    ...
    stack: {
      codesearch: {
        v1beta1: {
          ...
          > & { service: _build_stack_codesearch_v1beta1_CodeSearchDefinition };
          ...
          > & { service: _build_stack_codesearch_v1beta1_ScopesDefinition };
        };
      };
    };
  };
