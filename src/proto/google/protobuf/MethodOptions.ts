...
import type {
  OperationInfo as _google_longrunning_OperationInfo,
  OperationInfo__Output as _google_longrunning_OperationInfo__Output,
} from '../../google/longrunning/OperationInfo';
import type {
...
export interface MethodOptions {
  ...
  '.google.longrunning.operationInfo'?: _google_longrunning_OperationInfo | null;
...
export interface MethodOptions__Output {
  ...
  '.google.longrunning.operationInfo': _google_longrunning_OperationInfo__Output | null;
  '.google.api.methodSignature': string[];
