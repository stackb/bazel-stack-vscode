...
import type { InfoRequest as _livegrep_InfoRequest, InfoRequest__Output as _livegrep_InfoRequest__Output } from '../livegrep/InfoRequest';
...
export interface CodeSearchDefinition extends grpc.ServiceDefinition {
  Info: MethodDefinition<_livegrep_InfoRequest, _livegrep_ServerInfo, _livegrep_InfoRequest__Output, _livegrep_ServerInfo__Output>
  Search: MethodDefinition<_livegrep_Query, _livegrep_CodeSearchResult, _livegrep_Query__Output, _livegrep_CodeSearchResult__Output>
}
