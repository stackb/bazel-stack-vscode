...
import type { SearchResult as _livegrep_SearchResult, SearchResult__Output as _livegrep_SearchResult__Output } from '../livegrep/SearchResult';
...
export interface CodeSearchResult {
  'stats'?: (_livegrep_SearchStats | null);
...
export interface CodeSearchResult__Output {
  'stats': (_livegrep_SearchStats__Output | null);
